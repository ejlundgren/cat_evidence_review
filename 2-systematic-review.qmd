...
This section will tally the evidence types encountered. This workflow is derived from a full R script in `scripts/2_analysis/2 meta and review summary.R`, which includes additional checks and tests and is fully interactive if you clone the repo. 
...
<figure>
  ...
  <figcaption><b>Fig. 1.</b> The number of studies found with quantitative evidence on the relationship between cats and threatened species Fill color indicates the article type and whether their results (according to the author's interpretation) found a negative association between cats and threatened species. </figcaption>
</figure>
