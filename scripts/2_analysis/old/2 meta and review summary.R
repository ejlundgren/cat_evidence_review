...
#
#
guide[, analysis_effect_size := word(analysis_group, -1, sep = "_")]
...
intercepts$analysis_group <- factor(intercepts$analysis_group,
...
p1 <- ggplot()+
  ...
  geom_text(data = intercepts[analysis_group %in% "abundance_Zr"], 
            aes(x = "All species", y = -4, #hjust = 2,
               label = string),
            color = "grey50",
            size = 3)+
  geom_jitter(data = dat.long[analysis_group %in% "abundance_Zr"], 
  ...
  geom_errorbar(data = intercepts[analysis_group %in% "abundance_Zr"], 
                aes(x = "All species", 
                    ymin = lower_ci, ymax = upper_ci),
                width = .25)+
  geom_pointrange(data = intercepts[analysis_group %in% "abundance_Zr"], 
...
p2 <- ggplot()+
  geom_hline(yintercept = 0, linetype = "dashed")+
  geom_text(data = intercepts[analysis_group %in% "abundance_lnOR"], 
            aes(x = "All species", y = -4, #hjust = 2,
                label = string),
            color = "grey50",
            size = 3)+
  geom_jitter(data = dat.long[analysis_group %in% "abundance_lnOR"], 
              aes(x = "All species", y = yi_analysis, 
                  size = 1/vi_analysis, fill = yi_analysis),
              shape = 21, #fill = "grey90",
              height = 0, width = 0.25,
  ...
  scale_fill_gradient2(low = "dodgerblue", high = "indianred",
                       midpoint = 0, mid = "white")+
  guides(size = "none", fill = "none")+
  geom_errorbar(data = intercepts[analysis_group %in% "abundance_lnOR"], 
                aes(x = "All species", 
                    ymin = lower_ci, ymax = upper_ci),
                width = .25)+
  geom_pointrange(data = intercepts[analysis_group %in% "abundance_lnOR"], 
                  aes(x = "All species", y = pred,
                      ymin = lower_pi, ymax = upper_pi),
                  shape = 21, fill = "grey50",
                  size = 1)+
...
p3 <- ggplot()+
  geom_hline(yintercept = 0, linetype = "dashed")+
  geom_text(data = intercepts[analysis_group %in% "reproduction_SMD"], 
            aes(x = "All species", y = -2, #hjust = 2,
                label = string),
            color = "grey50",
            size = 3)+
  geom_jitter(data = dat.long[analysis_group %in% "reproduction_SMD"], 
              aes(x = "All species", y = yi_analysis, 
                  size = 1/vi_analysis, fill = yi_analysis),
              shape = 21, #fill = "grey90",
              height = 0, width = 0.25,
  ...
  scale_fill_gradient2(low = "dodgerblue", high = "indianred",
                       midpoint = 0, mid = "white")+
  guides(size = "none", fill = "none")+
  geom_errorbar(data = intercepts[analysis_group %in% "reproduction_SMD"], 
                aes(x = "All species", 
                    ymin = lower_ci, ymax = upper_ci),
                width = .25)+
  geom_pointrange(data = intercepts[analysis_group %in% "reproduction_SMD"], 
                  aes(x = "All species", y = pred,
                      ymin = lower_pi, ymax = upper_pi),
                  shape = 21, fill = "grey50",
                  size = 1)+
...
unique(class$analysis_group)
dat.long[analysis_group %in% "abundance_Zr", .(n = uniqueN(Article)),
         by = .(class, original_effect_size)]


class.abundance <- ggplot()+
  geom_hline(yintercept = 0, linetype = "dashed")+
  geom_text(data = class[analysis_group %in% "abundance_Zr", ],
  ...
  scale_fill_gradient2(low = "dodgerblue", high = "indianred",
                       midpoint = 0, mid = "white")+
  guides(size = "none", fill = "none")+
  geom_errorbar(data = class[analysis_group %in% "abundance_Zr"], 
                aes(x = class, 
                    ymin = lower_ci, ymax = upper_ci),
                width = .25)+
  geom_pointrange(data = class[analysis_group %in% "abundance_Zr"], 
                  aes(x = class, y = pred,
                      ymin = lower_pi, ymax = upper_pi),
                  shape = 21,
                  fill = "grey50",
...
class.long.abundance <- ggplot()+
  geom_hline(yintercept = 0, linetype = "dashed")+
  geom_text(data = class[analysis_group %in% "abundance_lnOR", ],
            aes(x = class, y = -10, hjust = 1,
                label = string),
            size = 3)+
  geom_jitter(data = dat.long[analysis_group %in% "abundance_lnOR" & !is.na(class)], 
              aes(x = class, y = yi_analysis, 
                  size = 1/vi_analysis, fill = yi_analysis),
              shape = 21, #fill = "grey90",
              height = 0, width = 0.25,
  ...
  scale_fill_gradient2(low = "dodgerblue", high = "indianred",
                       midpoint = 0, mid = "white")+
  guides(size = "none", fill = "none")+
  geom_errorbar(data = class[analysis_group %in% "abundance_lnOR"], 
                aes(x = class, 
                    ymin = lower_ci, ymax = upper_ci),
                width = .25)+
  geom_pointrange(data = class[analysis_group %in% "abundance_lnOR"], 
                  aes(x = class, y = pred,
                      ymin = lower_pi, ymax = upper_pi),
                  shape = 21,
                  fill = "grey50",
...
class.reproduction <- ggplot()+
  geom_hline(yintercept = 0, linetype = "dashed")+
  geom_text(data = class[analysis_group %in% "reproduction_SMD", ],
            aes(x = class, y = -2, hjust = 1,
                label = string),
            size = 3)+
  geom_jitter(data = dat.long[analysis_group %in% "reproduction_SMD" & !is.na(class)], 
              aes(x = class, y = yi_analysis, 
                  size = 1/vi_analysis, fill = yi_analysis),
              shape = 21, #fill = "grey90",
              height = 0, width = 0.25,
  ...
  scale_fill_gradient2(low = "dodgerblue", high = "indianred",
                       midpoint = 0, mid = "white")+
  guides(size = "none", fill = "none")+
  geom_errorbar(data = class[analysis_group %in% "reproduction_SMD"], 
                aes(x = class, 
                    ymin = lower_ci, ymax = upper_ci),
                width = .25)+
  geom_pointrange(data = class[analysis_group %in% "reproduction_SMD"], 
                  aes(x = class, y = pred,
                      ymin = lower_pi, ymax = upper_pi),
                  shape = 21,
                  fill = "grey50",
...
p.mass.1 <- ggplot()+
  geom_hline(yintercept = 0, linetype = "dashed")+
  geom_ribbon(data = mass[analysis_group %in% "abundance_Zr"], 
              aes(x = mass_g, 
                  ymin = lower_pi, ymax = upper_pi),
              alpha = .5,
              fill = "transparent",
  ...
  geom_ribbon(data = mass[analysis_group %in% "abundance_Zr"], 
              ...
              alpha = .5,
              fill = "grey")+
  geom_line(data = mass[analysis_group %in% "abundance_Zr"], 
            aes(x = mass_g, 
                y = pred),
            color = "black")+
  geom_jitter(data = dat.long[analysis_group %in% "abundance_Zr"], 
...
p.mass.2 <- ggplot()+
  geom_hline(yintercept = 0, linetype = "dashed")+
  geom_ribbon(data = mass[analysis_group %in% "abundance_lnOR"], 
              aes(x = mass_g, 
                  ymin = lower_pi, ymax = upper_pi),
              alpha = .5,
              fill = "transparent",
  ...
  geom_ribbon(data = mass[analysis_group %in% "abundance_lnOR"], 
              ...
              alpha = .5,
              fill = "grey")+
  geom_line(data = mass[analysis_group %in% "abundance_lnOR"], 
            aes(x = mass_g, 
                y = pred),
            color = "black")+
  geom_jitter(data = dat.long[analysis_group %in% "abundance_lnOR"], 
...
p.mass.3 <- ggplot()+
  geom_hline(yintercept = 0, linetype = "dashed")+
  geom_ribbon(data = mass[analysis_group %in% "reproduction_SMD"], 
              aes(x = mass_g, 
                  ymin = lower_pi, ymax = upper_pi),
              alpha = .5,
              fill = "transparent",
  ...
  geom_ribbon(data = mass[analysis_group %in% "reproduction_SMD"], 
              ...
              alpha = .5,
              fill = "grey")+
  geom_line(data = mass[analysis_group %in% "reproduction_SMD"], 
            aes(x = mass_g, 
                y = pred),
            color = "black")+
  geom_jitter(data = dat.long[analysis_group %in% "reproduction_SMD"], 
...
si_models[, Model := fcase(analysis_group == "abundance_Zr", "Short-term abundance (Zr)",
                           analysis_group == "abundance_lnOR", "Long-term abundance (lnOR)",
                           analysis_group == "reproduction_SMD", "Reproductive success (Hedges' g)")]
...
main_text <- si_models %>%
  ...
  mutate(term = ifelse(term == "log_mass", "log mass", term)) %>%
  select(Model, class, term, Estimate, `Test statistics`, `Sample size`, 
