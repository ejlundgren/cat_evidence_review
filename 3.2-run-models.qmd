...
Now we'll fit multilevel meta-analytic models in the R package `metafor` [@Viechtbauer2010-uq]. This workflow is derived from a full R script in `scripts/2_analysis/2 meta and review summary.R` that includes additional checks and tests and is fully interactive if you clone the repo.
