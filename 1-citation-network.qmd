...
This dataset allows us to evaluate whether claimants cited the available evidence, and whether there was any bias in citation towards articles that found a negative association between cats and prey.
...
Now we'll do a binomial model on articles that are population studies with data.
...
What percent of terminuses aren't quantitative evidence?
