...
Let's start by cleaning the environment and loading our data:
...
any(duplicated(names(data_evidence)))
...
Now let's explore the spatial dimensions of this with more granularity. First, by country:
...
How does it look by biogeographic realm?
```{r}
#| eval: true
#| echo: true
#| output: true
...
Finally, let's look at this on a world map:
```{r}
#| eval: true
#| echo: true
#| output: true
...
#| echo: true
#| output: true
mapview(cat_ex_map, zcol = "cat_arrival")
