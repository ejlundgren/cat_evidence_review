...
```
<figure>
  <img src="figures/main_text/network_legend.png" width="300">
  <figcaption><b>Figure 1:</b> Citation network. Claimant sources are core sources that claim that causes are drivers of endangerment. Non-claimants are sources (including the Web of Science) that do not make this claim. Point color indicates type of article found along each citation chain. </figcaption>
</figure>
...
#| fig-width: 9
#| fig-height: 7
#| fig-cap: "**Fig. 2.** The probability of a population study with data being cited by a claimant source was not influenced by whether the population study found evidence of a negative association between cats and prey (according author's own interpretation)."
...
<figure>
  ...
  <figcaption><b>Fig. 3.</b> Quantitative evidence cited found at the terminus of citation chains. X-axis indicates number of citation chains per evidence type. </figcaption>
</figure>
...
<figure>
  <img src="figures/main_text/network_legend_2.png" width="200">
  <figcaption><b>Fig. 5.</b> The terminus of citation chains across the citation network.</figcaption>
</figure>
