...
We'll now loop over this dataset based on the unique combinations of original effect size (`original_effect_size`) and destination effect size (`analysis_effect_size`). The effect size formulas we use here are given [here](3.5-effect-size-conversions.qmd).
